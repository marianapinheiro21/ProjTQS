...
public class DeleteMemberNegativeTest {
    ...
    @SneakyThrows
    @Test(description = "Delete Member with Success")       //Na documentação está explicito que deveria retornar o erro 404, no entanto está a devolver que apagou com sucesso um membro que não existe
